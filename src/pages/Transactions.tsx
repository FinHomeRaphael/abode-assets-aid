                  ...
                  <div className="min-w-0 flex-1">
                    <p className="text-sm font-semibold truncate flex items-center gap-1">
                      ...
                      {(isRecTemplate || isRecGenerated) && (
                        <span className="text-[10px] px-1 py-0.5 rounded-lg bg-primary/10 text-primary font-medium shrink-0">🔄</span>
                      )}
                      {isStopped && (
                        <span className="text-[10px] px-1 py-0.5 rounded-lg bg-muted text-muted-foreground font-medium shrink-0">⏹️</span>
                      )}
                      {(t as any).isAutoGenerated && (
                        <span className="text-[10px] px-1 py-0.5 rounded-lg bg-accent/20 text-accent-foreground font-medium shrink-0">🔄</span>
                      )}
                    </p>
