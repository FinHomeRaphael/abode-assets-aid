...
const Dashboard = () => {
  const { scopedTransactions: transactions, scopedBudgets: budgets, household, getMemberById, getBudgetSpent, getMonthSavings, getTotalSavings, scopedSavingsGoals: savingsGoals, getGoalSaved, getTransactionsForMonth, currentUser, householdId, scopedAccounts: accounts } = useApp();
